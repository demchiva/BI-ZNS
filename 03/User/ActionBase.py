...
class ActionBase(IActionBase):
    ...
    * self.player [PlayerTag] instance of your player for identification yourself in proxy
    ...
    def build_knight_v(self, check_uncertainly_module):
        self.game_control_proxy.spawn_unit(
            SpawnInformation(self.player,
                             GameObjectType.ARCHER,
                             check_uncertainly_module,
                             [], []))

    def build_knight_v2(self, check_uncertainly_module):
        self.game_control_proxy.spawn_unit(
            SpawnInformation(self.player,
                             GameObjectType.KNIGHT,
                             check_uncertainly_module,
    ...
    def build_druid(self, check_uncertainly_module):
        self.game_control_proxy.spawn_unit(
            SpawnInformation(self.player,
    ...
    def build_knight_v3(self, visible_free_tile):
        self.game_control_proxy.spawn_unit(
            SpawnInformation(self.player,
                             GameObjectType.KNIGHT,
                             visible_free_tile,
